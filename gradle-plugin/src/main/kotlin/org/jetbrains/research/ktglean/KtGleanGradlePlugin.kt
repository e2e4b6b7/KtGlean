...
class KtGleanGradlePlugin : KotlinCompilerPluginSupportPlugin {
    ...
    private val subpluginArtifact = SubpluginArtifact(
    ...
    override fun applyToCompilation(kotlinCompilation: KotlinCompilation<*>): Provider<List<SubpluginOption>> {
        ...
        val extension = project.extensions.getByType(KtGleanGradleExtension::class.java)
        return project.provider { listOf(SubpluginOption(outputDirectoryCLIKey, extension.outputDirectory)) }
    }
}
